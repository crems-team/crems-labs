    ...
    return (
        <MapProvider>
            ...
            <div className="container">
                <Panel ref={ref} header="Choose Area" headerTemplate={headerPane1} toggleable>

                    <div className="row">

                        <div className="col-md-8 col-sm-4"key={refreshKey}>
                            <div className="row">
                                    <div className='row mt-5'>
                                        <div className="col-md-4 p-float-label">
                                        ...
                                        <div className="p-float-label col-md-4  ">
                                    ...
                                    <div className='row mt-5'>
                                        ...
                                        <div className="p-float-label col-md-4 mt-5 ">
