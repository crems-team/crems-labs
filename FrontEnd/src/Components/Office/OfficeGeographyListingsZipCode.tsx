...
const OfficeGeographyListingsZipCode : React.FC<OtherComponentProps> = ({ id }) => {
    ...
    useEffect(() => {
            ...
            const fetchData=()=>{
                OfficeService.getOfficeDataGeoReport({id})
                .then((response: any) => {
  ...
  export default OfficeGeographyListingsZipCode;